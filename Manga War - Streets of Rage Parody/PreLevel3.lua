...
function changeScene4(event)
	local options = {effect = "fade", time = 10 }
	Ssound=audio.stop()
	storyboard.gotoScene( "GameLevel3", options)
end
...
function scene:createScene( event )
	...
	group:insert(block1)
	block2 = display.newImage("Images/MenuParts/FrameLvl3.png",480,0)
	group:insert(block2)
...
function scene:enterScene( event )
	...
	Timer1=timer.performWithDelay(Scenetime,changeScene4)
end
...
function scene:didExitScene( event )
	storyboard.purgeScene( "PreLevel3" )
end
