...
function changeScene1(event)
	local options = {effect = "fade", time = 100 }
	if Player.State==4 or ScoreCounter~=0 then 
	...
	elseif LevelSelected==1 then
		...
		storyboard.gotoScene( "PreLevel2", options)
	end
	end
end
...
function scene:createScene( event )
	...
	background1 = display.newImage("Images/Levels/Level01/Background1.png",0,0)
	group:insert(background1)
	background2 = display.newImage("Images/Levels/Level01/Background2.png",0,0)
	group:insert(background2)
	background3= display.newImage("Images/Levels/Level01/Background3.png",0,h-204)
	group:insert(background3)

	block1 = display.newImage("Images/MenuParts/FrameChar"..PlayerChoice..".png",0,0)
	group:insert(block1)
	block2 = display.newImage("Images/MenuParts/FrameLvl1.png",240,0)
	group:insert(block2)
	...
	WalkingArea = display.newRect( 0, h*0.50,w, h*0.45)
	WalkingArea.alpha=0
	...
	Boss={
		Name="Roronoa Zoro",Color="Green",MaxHealthAmount=75,Speed=4,Power=11,
		Rstand1=1,Rstand2=4,Rstand3=1600,
		Lstand1=11,Lstand2=4,Lstand3=1600,
		Rrun1=21,Rrun2=8,Rrun3=1000,
		Lrun1=31,Lrun2=8,Lrun3=1000,
		...
		if BossDead==0 then
			if Player.Health<=0 then
				...
				elseif LevelStage==2 and DeadChecker==0 and MovingSceneChecker==0 then
					...
					transition.to( background3, { x = background3.x-240, time = 4000} )	
...
function scene:enterScene( event )
	backSound=audio.play( Music1, { channel=1, loops=-1, fadein=100 }  ) 
...
function scene:didExitScene( event )
	storyboard.purgeScene( "GameLevel1" )
end
