...
function changeScene2(event)
	local options = {effect = "fade", time = 10 }
	Ssound=audio.stop()
	storyboard.gotoScene( "GameLevel2", options)
end
...
function scene:createScene( event )
	...
	group:insert(block1)
	block2 = display.newImage("Images/MenuParts/FrameLvl2.png",480,0)
	group:insert(block2)
...
function scene:enterScene( event )
	...
	Timer1=timer.performWithDelay(Scenetime,changeScene2)
end
...
function scene:didExitScene( event )
	storyboard.purgeScene( "PreLevel2" )
end
