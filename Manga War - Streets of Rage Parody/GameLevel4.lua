...
function changeScene7(event)
	...
	elseif GameDifficulty==1 then
		storyboard.gotoScene( "EndScreen2", options)
	elseif GameDifficulty<1 then
		storyboard.gotoScene( "PreLevel5", options)
	end
...
function scene:createScene( event )
	...
	background1 = display.newImage("Images/Levels/Level04/Background1.png",0,0)
	group:insert(background1)
	background2 = display.newImage("Images/Levels/Level04/Background2.png",0,0)
	group:insert(background2)
	background3= display.newImage("Images/Levels/Level04/Background3.png",0,h-100)
	group:insert(background3)

	block1 = display.newImage("Images/MenuParts/FrameChar"..PlayerChoice..".png",0,0)
	group:insert(block1)
	block2 = display.newImage("Images/MenuParts/FrameLvl4.png",240,0)
	group:insert(block2)
	...
	WalkingArea = display.newRect( 0, h*0.55,w, h*0.4)
	WalkingArea.alpha=0
	...
	Boss={
		Name="Monkey D. Luffy",Color="Red",MaxHealthAmount=60,Speed=3.8,Power=15,
		Rstand1=1,Rstand2=3,Rstand3=1200,
		Lstand1=11,Lstand2=3,Lstand3=1200,
		Rrun1=21,Rrun2=8,Rrun3=1000,
		Lrun1=31,Lrun2=8,Lrun3=1000,
...
function scene:enterScene( event )
	backSound=audio.play( Music4, { channel=1, loops=-1, fadein=100 }  ) 
...
function scene:didExitScene( event )
	storyboard.purgeScene( "GameLevel4" )
end
