...
function changeScene3(event)
	...
	elseif LevelSelected==2 then
		...
		storyboard.gotoScene( "PreLevel3", options)
	end
...
function scene:createScene( event )
	...
	background1 = display.newImage("Images/Levels/Level02/Background1.png",0,0)
	group:insert(background1)
	background2 = display.newImage("Images/Levels/Level02/Background2.png",0,0)
	group:insert(background2)
	background3= display.newImage("Images/Levels/Level02/Background3.png",0,h-100)
	group:insert(background3)

	block1 = display.newImage("Images/MenuParts/FrameChar"..PlayerChoice..".png",0,0)
	group:insert(block1)
	block2 = display.newImage("Images/MenuParts/FrameLvl2.png",240,0)
	group:insert(block2)
	...
	WalkingArea = display.newRect( 0, h*0.54,w, h*0.40)
	WalkingArea.alpha=0
...
function scene:enterScene( event )
	backSound=audio.play( Music2, { channel=1, loops=-1, fadein=100 }  ) 
