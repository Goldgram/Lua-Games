...
function changeScene9(event)
	...
	elseif GameDifficulty==0.85 then
		...
		storyboard.gotoScene( "PreLevel6", options)
	end
...
function scene:createScene( event )
	...
	background1 = display.newImage("Images/Levels/Level05/Background1.png",0,0)
	group:insert(background1)
	background2 = display.newImage("Images/Levels/Level05/Background2.png",0,0)
	group:insert(background2)
	background3= display.newImage("Images/Levels/Level05/Background3.png",0,h-200)
	group:insert(background3)

	block1 = display.newImage("Images/MenuParts/FrameChar"..PlayerChoice..".png",0,0)
	group:insert(block1)
	block2 = display.newImage("Images/MenuParts/FrameLvl5.png",240,0)
	group:insert(block2)
...
function scene:enterScene( event )
	backSound=audio.play( Music5, { channel=1, loops=-1, fadein=100 }  ) 
...
function scene:didExitScene( event )
	storyboard.purgeScene( "GameLevel5" )
end
